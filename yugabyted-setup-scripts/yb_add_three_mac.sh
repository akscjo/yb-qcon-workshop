...
# Start 5th node
printf "\nStarting node 5...\n"
$BASEDIR/yugabyte-2.19.2.0/bin/yugabyted start --advertise_address 127.0.0.5 --base_dir=$BASEDIR/node5 --cloud_location cloud.region1.node5 --fault_tolerance=zone --join=127.0.0.1 --tserver_flags="ysql_enable_packed_row=true,ysql_beta_features=true,yb_enable_read_committed_isolation=true,enable_deadlock_detection=true,enable_wait_queues=true" --master_flags="ysql_enable_packed_row=true"

# Start 6th node
printf "\nStarting node 6...\n"
$BASEDIR/yugabyte-2.19.2.0/bin/yugabyted start --advertise_address 127.0.0.6 --base_dir=$BASEDIR/node6 --cloud_location cloud.region1.node6 --fault_tolerance=zone --join=127.0.0.1 --tserver_flags="ysql_enable_packed_row=true,ysql_beta_features=true,yb_enable_read_committed_isolation=true,enable_deadlock_detection=true,enable_wait_queues=true" --master_flags="ysql_enable_packed_row=true"
